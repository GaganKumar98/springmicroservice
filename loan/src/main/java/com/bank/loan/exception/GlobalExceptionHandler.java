...
//    }
	...
	@ExceptionHandler(LoanAlreadyException.class)
	public ResponseEntity<ErrorResponseDto> handleLoanAlreadyExists(LoanAlreadyException ex, WebRequest webRequest) {
	...
	public ResponseEntity<ErrorResponseDto> handleGlobalResponse(Exception ex, WebRequest webRequest) {
		ErrorResponseDto errorResponseDto = new ErrorResponseDto(webRequest.getDescription(false),
